...
extern NSString *const STR_REAL_DURATION;
extern NSString *const STR_PLANNED_DURATION;
extern NSString *const STR_TOTAL_DURATION;
...
@interface TTItem : NSObject
{
    ...
    NSDate   *dtStartTime;
    NSDate   *dtEndDate;
//    NSNumber *numPlannedDuration;
//    NSNumber *numRealDuration;
    int      *numRate;
    NSString *strColor;
...
@property(nonatomic, assign) NSNumber *numPlannedDuration;
@property(nonatomic, assign) NSNumber *numRealDuration;
